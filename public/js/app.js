...
$packages["github.com/buddhamagnet/gopherj/js/utils"] = (function() {
	var $pkg = {}, $init, js, window, sliceType, ptrType, global;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	window = $pkg.window = $newType(0, $kindStruct, "utils.window", "window", "github.com/buddhamagnet/gopherj/js/utils", function(JS_, Console_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.JS = null;
			this.Console = null;
	...
	window.ptr.prototype.Alert = function(msg) {
		var $ptr, msg, w;
		w = $clone(this, window);
		w.JS.alert($externalize(msg, $String));
	};
	window.prototype.Alert = function(msg) { return this.$val.Alert(msg); };
	window.ptr.prototype.Log = function(msg) {
		var $ptr, msg, w;
		w = $clone(this, window);
		w.Console.log($externalize(msg, $String));
	};
	window.prototype.Log = function(msg) { return this.$val.Log(msg); };
	window.ptr.prototype.Call = function(obj, function$1, args) {
		var $ptr, args, function$1, obj, object, w;
		w = $clone(this, window);
		object = w.JS[$externalize(obj, $String)];
		object[$externalize(function$1, $String)]($externalize(args, sliceType));
	};
	window.prototype.Call = function(obj, function$1, args) { return this.$val.Call(obj, function$1, args); };
	window.methods = [{prop: "Alert", name: "Alert", pkg: "", typ: $funcType([$String], [], false)}, {prop: "Log", name: "Log", pkg: "", typ: $funcType([$String], [], false)}, {prop: "Call", name: "Call", pkg: "", typ: $funcType([$String, $String, sliceType], [], true)}];
	window.init([{prop: "JS", name: "JS", pkg: "", typ: ptrType, tag: ""}, {prop: "Console", name: "Console", pkg: "", typ: ptrType, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		global = $global.window;
		$pkg.Window = new window.ptr(global, global.console);
		/* */ } return; } if ($f === undefined) { $f = { $blk: $init }; } $f.$s = $s; $f.$r = $r; return $f;
	};
	$pkg.$init = $init;
	return $pkg;
...
$packages["main"] = (function() {
	var $pkg = {}, $init, utils, sliceType, main;
	utils = $packages["github.com/buddhamagnet/gopherj/js/utils"];
	sliceType = $sliceType($String);
	main = function() {
		var $ptr;
		$pkg.Window.Alert("Hello Dave!");
		$pkg.Window.Log("And I'm here too!");
		$pkg.Window.Call("console", "log", new sliceType(["And I am clever!"]));
	};
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = utils.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		$pkg.Window = $clone(utils.Window, utils.window);
		if ($pkg === $mainPkg) {
			main();
		}
		/* */ } return; } if ($f === undefined) { $f = { $blk: $init }; } $f.$s = $s; $f.$r = $r; return $f;
